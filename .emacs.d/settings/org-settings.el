;; much (all) of this code comes from http://doc.norang.ca/org-mode.html
;;;
;;; Org Mode
;;;
; 4.2 Org-Mode Setup --------------------------------------------
...
(require 'org)
(require 'org-habit) ; Needed to add this tor fix an import problem
;;
...
(setq org-todo-keywords
      (quote ((sequence "TODO(t)" "NEXT(n)" "|" "DONE(d)")
              (sequence "|" "HOLD(h@/!)" "CANCELLED(c@/!)" "TXFR(X)")
              (sequence "WAITING(w@/!)" "|" "SOMEDAY(s)")
              (sequence "PHONE" "MEETING" "NOTE" "LOGX")
...
(setq org-todo-keyword-faces
      (quote (("TODO" :foreground "red" :weight bold)
              ...
              ("MEETING" :foreground "orange" :weight bold)
              ("NOTE" :foreground "DarkGoldenrod" :weight bold)
              ("PHONE" :foreground "forest green" :weight bold)
              ("LOGX" :foreground "Goldenrod" :weight bold)
              )))
...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/org/gtd.org" "inbox")
             "* TODO %?\n  CREATED: %U\n  %i\n")      
        ("l" "Logx" entry (file+datetree "~/org/logx.org")
             "* %T %?\n %i\n")
        ("#" "topic" entry (file "~/org/topics.org")
             "* topic %?\n  CREATED: %U\n %i\n")
        ("j" "Journal" entry (file+datetree "~/org/journal.org")
             "* %?\n  CREATED: %U\n  %i\n")))
;; Capture templates for: TODO tasks, Notes, appointments, phone calls, meetings, and org-protocol
(setq org-capture-templates
      (quote (("t" "(t)odo" entry (file "~/org/refile.org")
               "* TODO %? :note:\n :LOGBOOK:\n CREATED: %U\n :END:\n" :clock-in t :clock-resume t)
              ("e" "m(e)eting" entry (file "~/org/refile.org")
               "* MEETING %? :meeting:\n :LOGBOOK:\n CREATED: %U\n :END:\n" :clock-in t :clock-resume t)
              ...
              ("m" "(m)aintenance")
              ("mm" "(m)aintenance" entry (file+datetree "~/org/logx.org")
                                  "* maintenance %? :maintenance:\n  %i\n" :clock-in t :clock-resume t)              
              ("mg" "(g)et ready" entry (file+datetree "~/org/logx.org")
                                  "* maintenance %? :maintenance:\n  %i\n" :clock-in t :clock-resume t)                          
